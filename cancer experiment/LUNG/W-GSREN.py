...
gl = GroupLasso(groups=groups,group_reg=0.000000001,l1_reg=0.001,frobenius_lipschitz=True,scale_reg="none",
                subsampling_scheme=None,supress_warning=True,n_iter=1000,tol=1e-3,)
gl.fit(X_train, Y_train)
coefs_train = gl.coef_

def group_square_root_EN(X, y, groups, lambd1, lambd2,W_i,W_g,max_iter=1000, tol=1e-3):  # W_g,
...
def calc_lambd(x_pos,x_neg,Y_train,m,n,a_l,groups):
    ...
    for i in a_l:
        ...
        for k in range(n):  #10折,每折总24个样本，正负12个
            ...
            mybeta =  group_square_root_EN(X, y, groups, lambd1, lambd2,W_i, W_g,max_iter=1000, tol=1e-3) #, W_g
